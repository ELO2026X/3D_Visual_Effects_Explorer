          ...
          <div key={category.name}>
            ...
            <ul className="space-y-1">
              {category.effects.map((effect) => (
                <li key={effect.name}>
                  <button
                    className={`w-full text-left p-2 rounded-md transition-colors duration-200 focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:outline-none disabled:opacity-50 disabled:cursor-not-allowed

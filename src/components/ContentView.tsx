...
export const ContentView: React.FC<ContentViewProps> = ({
  ...
  return (
    <main id="main-content" tabIndex={-1} className="flex-1 flex flex-col p-4 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:ring-inset">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-4 min-h-0">
        ...
        <div className="w-full lg:w-1/3 bg-gray-700 rounded-lg p-4 overflow-y-auto border border-gray-600">
          ...
          {isLoading ? (
            <div aria-live="polite" className="text-white flex flex-col items-center py-8">
